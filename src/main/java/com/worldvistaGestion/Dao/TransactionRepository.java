...
public interface TransactionRepository extends CrudRepository<Transaction, Long>{
	...
	//for Admin && User
	@Query("select NEW com.worldvista.Gestion.Pojo.transac( t.idTransaction , t.dateTransaction , t.typeTransaction , t.mtTransaction) from Transaction t where t.dateTransaction =:x order by t.mtTransaction desc")
	...
	@Query("select t from Transaction t where t.idUser =:idUser order by t.mtTransaction  desc")
	 List<Transaction> getTopTransactionById(Long idUser);
